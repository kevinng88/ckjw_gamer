class GameOverScreen {
    create(){
        ...
        var losingDescription = `You die,\r\r ${PIG_DIED_DUE_TO_FIRE} pigs was died before you save them,\r\ralthough you saved ${pigScore} piglets \r\rand you saved ${fireScore} fire`;
